...
name: humanizer-pro
description: |-
  专业文档去 AI 味子技能（中英通用）：发版说明/changelog/公告、PR 与 issue 回复、代码评审意见、事故复盘/RCA、工单与工单报告、技术文章/博客/教程、长篇新闻（特稿/调查/数据报道/采访）。目标不是骗过检测器，而是文本承载信息、有立场、读起来像署名者本人。触发词：发版说明、release notes、PR 回复、复盘、postmortem、RCA、工单、技术文章、博客、新闻报道、去AI味。属 humanizer 主路由的子技能，可独立使用。v7.1.0。
---
